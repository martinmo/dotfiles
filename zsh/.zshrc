...
# Shortcuts to temporarily disable tunneled SSH and shared connections
alias directssh='ssh -o ProxyCommand=none -o ControlPath=none'
alias directscp='scp -o ProxyCommand=none -o ControlPath=none'
